...
export default {
    ...
    "Automount USB Drive": "Montage automatique de la clé USB",
    ...
    "Storage Status": "État de stockage",
    ...
    "Sort by": "Trier par",
    "Click icon to import apps into CasaOS": "Cliquez sur l'icône pour importer des applications dans CasaOS",
    "Drag icons to sort": "Faites glisser les icônes pour les classer",
    ...
    "[Optional]": "[Optionnel]",
    "Notice: If there are multiple services, only the first set can be analyzed correctly": "Avis : S'il existe plusieurs services, seul le premier ensemble peut être analysé correctement",
    "No need": "Pas nécessaire",
    ...
    ********************************/
    ...
    "Copy friend's ID": "Copier l'identifiant d'un ami",
