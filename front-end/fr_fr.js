...
export default {
    ...
    "Automount USB Drive": "Montage automatique du lecteur USB",
    "Wallpaper": "Fond d\'écran",
    "Change wallpaper": "Changer le fond d\'écran",
    "Show Search Bar": "Afficher la barre de recherche",
    "Show Recommended Apps": "Afficher les apps recommandées",
    "Upgrade Now": "Mettre à niveau maintenant",
    "Enabling this function may cause boot failures when the Raspberry Pi device is booted from USB": "L\'activation de cette fonction peut entraîner des échecs de démarrage lorsque le périphérique Raspberry Pi est démarré à partir de l\'USB",
    ...
    "Install": "Installer",
    "Config": "Config",
    "Failed to start, please try again.": "Le démarrage a échoué, veuillez réessayer.",
    "Syncthing is not running, start it?": "Syncthing ne fonctionne pas, démarrez-le ?",
    ...
    "Container Capabilities (cap-add)": "Capacités des conteneurs (cap-add)",
    "Container Hostname": "Nom d\'hôte du conteneur",
    "Hostname of app container": "Nom d\'hôte du conteneur de l\'application",
    "Ports": "Ports",
    "Volumes": "Volumes",
    ...
    "e.g.,hello-world:latest": "par exemple, hello-world:latest",
    ...
    "Community Apps": "Applications fournies par la communauté",
    ...
    "Import to CasaOS": "Importer vers CasaOS",
    "Existing Docker Apps": "Apps Docker existantes",
    "Port [Please add a ports set first]": "Port [Veuillez ajouter un ensemble de ports d'abord]",
    "[Optional]": "[Facultatif]",
    "Notice: If there are multiple services, only the first set can be analyzed correctly": "Remarque : S'il y a plusieurs services, seul le premier ensemble peut être analysé correctement.",
    ...
    "Apply": "Appliquer",
    "Just Mount": "Monter juste",
    "Storage Name": "Nom du stockage",
    "Choose Drive": "Choisir un lecteur",
    ...
    "Upload Files": "Fichiers à télécharger",
    "Upload Folder": "Dossier à télécharger",
    ...
    "Are you sure you want to <b>delete</b> these files? This action cannot be undone.": "Etes-vous sûr de vouloir <b>supprimer</b> ces fichiers ? Cette action ne peut pas être annulée.",
    "select-items": "Sélectionnez {nombre} éléments",
    "total-items": "Total {nombre} éléments",
    "cancel-all": "Annuler tout",
    "Paste - Overwrite": "Coller - Ecraser",
    "Paste - Skip": "Coller - Passer",
    "Set as wallpaper": "Définir comme fond d'écran",
    "Set wallpaper successfully.": "Fond d'écran défini avec succès.",
    "Save failed, please try again!": "La sauvegarde a échoué, veuillez réessayer !",
