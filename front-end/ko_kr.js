...
export default {
    ...
    "Config": "설정",
    "Complete": "완료",
    "Download Syncthing on the device you want to sync with CasaOS": "CasaOS와 동기화하려는 장치에 동기화 앱을 다운로드합니다",
    ...
    "Device ID": "장치 ID",
    "Fill in your Device ID to continue": "계속하려면 장치 ID를 입력하십시오",
    "How to get Device ID": "장치 ID을 얻는 방법",
    "What do I need to do on my device?": "내 장치에서 무엇을 해야 합니까?",
    "Open the SyncTrayzor": "SyncTrayzor 열기",
    "Find the Device ID": "장치 ID 찾기",
    "Add new device on your device": "장치에 새 장치 추가",
    "Add new folder on your device": "장치에 새 폴더 추가",
    "Done!": "완료!",
    ...
    'Choose "Show device ID"': '"장치 ID 표시"을 선택합니다',
    "Copy the Device ID": "장치 ID을 복사합니다",
