...
export default {
    ...
    // Login
    "Login": "Anmelden",
    "Password error!": "Das Passwort scheint falsch zu sein!",
    ...
    "Edit Web UI port": "Port der Web-UI bearbeiten",
    ...
    "Follow the guide to start syncing your files across multiple devices.": "Folge der Anleitung, um deine Dateien über mehrere Geräte hinweg zu synchronisieren.",
    "Go !": "Jetzt loslegen!",
    "Sync Guide": "Einrichtung der Synchronisation",
    "Install": "Installation",
    "Config": "Konfiguration",
    "Complete": "Abschluss",
    "Download Syncthing on the device you want to sync with CasaOS": "Lade Syncthing auf jeden Gerät, welches du mit CasaOS synchronisieren möchtest, herunter",
    "Get Syncthing for": "Installiere Syncthing für {os}",
    "Download APK": "APK herunterladen",
    "Show all Platforms": "Alle Plattformen anzeigen",
    'Install and open the downloaded application, then click the "Next" button.': 'Installiere und öffne die heruntergeladene App, bevor du dann den "Weiter"-Button klickst.',
    "Device ID": "Geräte-ID",
    "Fill in your Device ID to continue": "Trage deine Geräte-ID zum Fortfahren ein",
    "How to get Device ID": "Device-ID auslesen",
    "What do I need to do on my device?": "Was muss ich auf meinem Gerät ausführen?",
    ...
    "Add new folder on your device": "Neuen Ordner auf deinem Gerät hinzufügen",
    "Done!": "Fertig!",
    ...
    "Your data has started to sync.It may take some minutes to fulfill synchronization.": "Deine Dateien fangen nun an zu synchronisieren.<br>Es dauert einen kleinen Moment bis zur Fertigstellung.",
    "Up to Date": "Aktuell",
    ...
    "Attention": "Achtung",
    "Data cannot be recovered after deletion! <br>Continue on to uninstall this application?": "Deine Daten können nicht wiederhergestellt werden! <br>Willst du mit der Deinstallation fortfahren der App?",
    ...
    "Your browser does not support file reading.": "Dein Browser unterstützt nicht das auslesen von Dateien.",
    ...
    "AutoFill only helps you to complete most of the configuration.": "AutoFill hilft dir nur beim Ausfüllen des größten Teils der Konfiguration.",
    ...
    "Feel free to suggest improvements to this feature in Discord Server!": "Du kannst gerne Verbesserungen für diese Funktion im Discord Server vorschlagen!",
